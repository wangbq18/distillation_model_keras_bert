...
class StudentCNN:
    ...
    def create_model(self):
        ...
        emb = Dropout(0.2)(emb)
        conv1 = Conv1D(768, 3, activation='relu')(emb)
        conv2 = Conv1D(768, 3, activation='relu')(conv1)
        poolings1 = GlobalMaxPooling1D()(conv1)
        poolings2 = GlobalMaxPooling1D()(conv2)
    ...
    def train(self):
        ...
        for epoch in range(steps):
            ...
            if f1 > best_score:
                ...
                y_vals = y_val_pre
                model.save_weights('data/distil_model')
            ...
            if patient >= 10:
                break
        # ==========加载最优模型预测测试集=========== #
        model.load_weights('data/distil_model')
